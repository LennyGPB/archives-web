...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-auto border-t border-white/10 bg-[#08090a] px-4 py-4 md:px-24 md:py-6 lg:px-36">
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between md:gap-4">
        <Link className="inline-flex shrink-0 items-center gap-2 text-sm font-semibold tracking-widest text-white/70 no-underline" href={home} aria-label={dict.nav.homeAria}>
          <Image alt="" className="h-5 w-auto shrink-0 md:h-6" height={3840} src="/logo_orha.png" width={2160} />
          <span>ORHA<span className="text-[#86a98d]">:</span></span>
        </Link>

        <nav className="flex flex-wrap items-center gap-x-4 gap-y-1.5 md:gap-x-5 md:gap-y-2" aria-label={dict.footer.legalHeading}>
        ...
        <p className="m-0 shrink-0 font-[family-name:var(--font-geist-mono)] text-[9px] tracking-wider text-white/30 md:text-[10px]">
